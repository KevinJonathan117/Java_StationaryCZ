...
public class Login extends javax.swing.JFrame {
    ...
    public static String KODE_USER, NAMA_USER, JABATAN_USER;
    Menu FormMenu;
    ...
    private void initComponents() {
        ...
        jLabel6.setText("You haven't register yet ? Click Here!");
        ...
        buttonLogin.setFont(new java.awt.Font("SansSerif", 0, 24)); // NOI18N
        buttonLogin.setForeground(new java.awt.Color(102, 0, 0));
    ...
    private void jLabel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseClicked
        ...
        formsignup.setLocationRelativeTo(null);
    ...
    private void buttonLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonLoginActionPerformed
        ...
        for (int i = 0; i < allPegawai.size(); i++) {
            if (allPegawai.get(i).getUSERNAME().equals(textUsername.getText()) &&
                allPegawai.get(i).getPASSWORD().equals(textPassword.getText())
               )
               pos=i;
        }
        if (pos==-1){
            ...
            FormMenu = new Menu();
            KODE_USER = allPegawai.get(pos).getIDPEG();
